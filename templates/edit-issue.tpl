...
<html lang="zh-cmn-Hans">
			...
			<section class="issue-form-area">
				...
				<div class="issue-form-item goods-title">
					...
					<div class="form-value">
						<div class="form-input-wr delete-goods">
							<a href="javascript:;" id="delete-goods-btn">删除信息</a>
	...
	<script type="text/javascript" src="./scripts/lib/photoUpload/dist/lrz.bundle.js"></script>
	<script type="text/javascript" src="./scripts/issue/sea.js" id="seajsnode"></script>
	<script type="text/javascript" src="./scripts/issue/edit-issue-config.js"></script>
