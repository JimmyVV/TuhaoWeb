define(function(require, exports, module) {
    ...
    var uploadFiles = [],
        goodsName,
        mes,
        proId = parseInt(window.location.search.split('=')[1]),
    ...
    function setAjaxForm(goods) {
        ...
        mForm.append("id", proId);
        $.ajax({
            url: "doPerson/editPro.php?active=editDetails",
            type: "POST",
            data: mForm,
            processData: false,
            contentType: false,
...
//              	mes.show("上传success");
    ...
    $(function() {
        ...
        $.ajax({
            url: "doPerson/editPro.php?active=edit",
            type: "POST",
            data: {
                id: proId
            },
            success: function(data) {
                util.initForm(data, uploadFiles);
            },
            error: function() {
                mes.show("数据加载失败");
            }
        ...
        // util.initForm(jsonData, uploadFiles);
...
//      });
        ...
        //删除物品
        $('#delete-goods-btn').on('click',function(){
        	$.post('doPerson/editPro.php?active=delete',{id:proId},function(res){
        		mes.show(res.mes);
        		if (res.success) {
